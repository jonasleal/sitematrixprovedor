            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.paginas.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <x-input-label for="slug" :value="__('URL Personalizada (Opcional - ex: sobre-nos)')" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select id="template" name="template" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="padrao">Padrão Institucional</option>
                                <option value="faq">Perguntas Frequentes (FAQ)</option>
                                <option value="downloads">Central de Downloads</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-6">
                        <x-editor-html name="conteudo" label="Conteúdo da Página" :value="old('conteudo')" />
                    </div>
